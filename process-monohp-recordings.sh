...
do
  ...
  f2=${out}.flac
  # flac --best $f -o $f2
  sox $f -t wav - remix 1 highpass 250 | flac - --best -o - > $f2

  # high-level spectrogram for reviewing presence / absence of birds
  sox $f2 -n channels 1 rate 22k spectrogram -o ${out}-sm.png -m -l -x1600 -z100
  # detailed spectrogram for bird id
  sox $f2 -n channels 1 rate 22k spectrogram -o ${out}-lg.png -m -l -x4800 -z100
